#!/bin/bash -       
#title           :send_PyQt.sh
#description     :This script will compress all .py and .opt files in the current directory and send it to /home/TP/TPrendu/nedelec/CAI/TkInter/
#author		     :Maël CREAC'H
#date            :14/11/2023
#version         :0.2
...
rsync -av --exclude='*.sh' --exclude='__pycache__' --exclude='Utils' ./ ./${folder_name}
